    ...
    try:
        ...
        for i, form in enumerate(browser.forms()):
            ...
            for control in form.controls:
                ...
                print(f"    {control.type}: name='{control.name}' id='{
                      control_info['id']}' value='{control_info['value']}'")
...
def main():
    ...
    search_pages = [
        ...
        ('https://www.handelsregister.de/rp_web/erweitertesuche.xhtml?cid=2',
         'Advanced Search')
    ]
    ...
    for url, page_name in search_pages:
        ...
        can_submit, form_index, form_name, search_field = test_form_submission(
            browser, url, page_name)
    ...
    if working_pages:
        ...
        for page in working_pages:
            ...
            print(f"    Form: {page['working_form_name']
                               } (field: {page['search_field_name']})")
    else:
